...
**Landing Page - Procesos naturales y artísticos**

Esta es mi primera página web, desarrollada como un proyecto personal para representar la esencia de **Chema ES DAR**. El objetivo principal fue crear una experiencia visual sencilla, clara y armónica que refleje el espíritu artesanal del emprendimiento.

---

## Sobre el Proyecto

Chema es un proyecto que une la naturaleza con el arte textil. Esta landing page fue diseñada para mostrar:
...
Para este desarrollo me enfoqué en las bases del desarrollo web moderno, priorizando la estructura y el diseño responsive:

* **HTML5:** Estructura semántica (uso de `<section>`, `<header>`, `<footer>`).
...
Puedes visitar la versión en vivo del sitio haciendo clic aquí:  
[Netlify](https://chema.netlify.app/)
